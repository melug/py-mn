:mod:`Тэмдэгт төрөл` Нийтлэг хэрэглэгдэх үйлдэл
===============================================

.. module:: Тэмдэгт төрөл
   :synopsis: Нийтлэг хэрэглэх үйлдлүүд
...
Тогтмолуудыг дор жагсаав.


.. data:: ascii_letters

   :const:`ascii_lowercase` болон :const:`ascii_uppercase` -ийн доор тайлбарлах 
   тогтмолуудын нийлбэр юм.  Энэ утга нь хэлнээс хамааралгүй.


.. data:: ascii_lowercase

   Жижиг үсгүүд ``'abcdefghijklmnopqrstuvwxyz'``. Эдгээр нь
   өөрчлөгдөхгүй.  


.. data:: ascii_uppercase

   Том үсгүүд ``'ABCDEFGHIJKLMNOPQRSTUVWXYZ'``.  Энэ утга нь хэлнээс хамааралгүй ба
   өөрчлөгдөхгүй.


.. data:: digits

   Тэмдэгт ``'0123456789'``. Тайлбар: 10-тын тооллын системийн тоонууд(цифрүүд)


.. data:: hexdigits

   Тэмдэгт ``'0123456789abcdefABCDEF'``. Тайлбар: 16-тын тооллын системийн тоонууд


.. data:: letters

   Өмнө тайлбарласан том жижиг үсгүүдийн нийлбэр.  Энэ тусгай утга нь хэлнээс хамааралтай , :func:`locale.setlocale` 
   функцийг дуудахад утга нь засагдана.


.. data:: lowercase

   Энэ тэмдэгт нь жижиг бүх үсгийг агуулсан байна.
   Ихэнх системд тэмдэгт нь  ``'abcdefghijklmnopqrstuvwxyz'`` байна.Энэ тусгай утга нь хэлнээс 
   хамааралтай , :func:`locale.setlocale` функцийг дуудахад утга нь засагдана.


.. data:: octdigits

   Тэмдэгт ``'01234567'``.Тайлбар: Наймтын тооллын системийн тоонууд
